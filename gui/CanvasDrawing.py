...
class CanvasDrawing(tkinter.Frame):
    ...
    def __init__(self, container, controller):
        ...
        tkinter.Button(self, text='Main Screen', bg='#FFFFFF', font=('arial', 15, 'normal'), command=lambda: self.controller.show_frame("MainScreen")).place(x=428, y=550)
        tkinter.Button(self, text='Clear', bg='#FFFFFF', font=('arial', 15, 'normal'), command=self.clear_canvas).place(x=350, y=550)
